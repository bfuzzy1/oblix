import { Oblix } from "../core/network.js";
import { drawLossGraph } from "../visualization/drawLossGraph.js";
import { drawNetwork } from "../visualization/drawNetwork.js";
...
if (typeof document !== "undefined") {
  ...
  document.getElementById("generateDataBtn").addEventListener("click", () => {
    ...
    try {
      ...
      drawNetwork(nn, networkCanvas, networkCtx);
    } catch (error) {
  ...
  trainButton.addEventListener("click", async () => {
    ...
    lossHistory = [];
    drawLossGraph(lossCtx, lossCanvas, lossHistory);
    try {
